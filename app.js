...
function multiply(a, b) { //eslint-disable-line
  var multiply = a * b;
  var message2 = 'The product of ' + a + ' and ' + b + ' is ' + multiply + '.';
  var product = [multiply, message2];
  return product;
}
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  var addMessage = a + ' and ' + b + ' and ' + c + ' sum to ' + totalSum + '.';
...
function sumArray(testArray) { //eslint-disable-line
  var arraySum = sum(a, sum(b, c)[0])[0];
  var arraymessage = a + +b + c + ' was passed in as an array of numbers, and ' + arraySum + '.';
  var lastLine = [arraySum, arraymessage];
  return lastLine;
}
